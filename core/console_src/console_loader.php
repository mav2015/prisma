...
class console_loader
{
    ...
    public function action($command)
    {
        ...
        echo "Wrong command...\n";
        echo "Try with php console init | make | database | transfer\n";
    }
    ...
    private function transfer($param, $flag = null)
    {
        ...
        if ($param[1] == 'all') {
            ...
            echo "the all option will transfer all files and folders\n";
    ...
    private function remove($param, $flag = null)
    {
        ...
        if ($param[1] == 'database') {
            ...
            die();
        } elseif ($param[1] == 'apicontroller') {

            console_files::remove($this->apiControllerFolder . $param[2] . 'Controller.php');
            die();
        }

        echo "Wrong command...\n";
        echo "Try with php console remove: database | mvc | apicontroller : mymodule\n";
    }
}
